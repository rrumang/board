			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="row">
					<div class="col-sm-8 blog-main">
						...
						<form action="${pageContext.request.contextPath }/articleModify" method="post" id="frm2" enctype="multipart/form-data">

							<div class="form-group">
								<label for="userNm" class="col-sm-2 control-label">제목</label>
								<div class="col-sm-10">
									<input type="text" id="title" name="title" class="control-label" value="${vo.title}" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10" id="filediv">
									<c:forEach items="${fileList }" var="file" varStatus="status">
										<c:choose>
												<c:when test="${vo.userId == userId }">
													<tr class="fileTr">
														<td>${file.fileName}<a href="${pageContext.request.contextPath}/fileDelete?fileId=${file.fileId}&articleId=${articleId}">&nbsp;X</a></td><br>
													</tr>
												</c:when>
												<c:otherwise>
													<tr class="fileTr">
